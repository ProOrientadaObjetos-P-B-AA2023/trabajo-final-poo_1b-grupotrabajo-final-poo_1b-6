...
public class Inmobiliaria {
    ...
    public static Casa ingresarCasa(List<Propietario> propietarios,
        ...
        if (opcion == 1) {
            ...
            try {
                propietarioIndex = validarEnteroRango("Ingrese el número de propietario: ", scanner, 1, propietarios.size());
            } catch (InputMismatchException | IllegalArgumentException e) {
                System.out.println("Error: Ingrese un número válido de propietario.");
                return null;
            }
            ...
            try {
                precioMetroCuadrado = validarNumero("Precio por metro cuadrado: ", scanner);
            } catch (InputMismatchException e) {
                System.out.println("Error: Ingrese un número válido para el precio por metro cuadrado.");
                return null;
            }

            double metrosCuadrados;
            try {
                metrosCuadrados = validarNumero("Número de metros cuadrados: ", scanner);
            } catch (InputMismatchException e) {
                System.out.println("Error: Ingrese un número válido para el número de metros cuadrados.");
                return null;
            }
            ...
            int barrioIndex;
            try {
                barrioIndex = validarEnteroRango("Ingrese el número de barrio: ", scanner, 1, barrios.size());
            } catch (InputMismatchException | IllegalArgumentException e) {
                System.out.println("Error: Ingrese un número válido de barrio.");
                return null;
            }
            ...
            int ciudadIndex;
            try {
                ciudadIndex = validarEnteroRango("Ingrese el número de ciudad: ", scanner, 1, ciudades.size());
            } catch (InputMismatchException | IllegalArgumentException e) {
                System.out.println("Error: Ingrese un número válido de ciudad.");
                return null;
            }
            ...
            int numeroCuartos;
            try {
                numeroCuartos = validarEntero("Número de cuartos: ", scanner);
            } catch (InputMismatchException e) {
                System.out.println("Error: Ingrese un número válido para el número de cuartos.");
                return null;
            }
            ...
            int constructoraIndex;
            try {
                constructoraIndex = validarEnteroRango("Ingrese el número de constructora: ", scanner, 1, constructoras.size());
            } catch (InputMismatchException | IllegalArgumentException e) {
                System.out.println("Error: Ingrese un número válido de constructora.");
                return null;
            }
    ...
    public static int validarEnteroRango(String mensaje, Scanner scanner, int min, int max) {
        int numero;
        while (true) {
            try {
                System.out.print(mensaje);
                ...
                scanner.nextLine();
                System.out.println("Error: Ingrese un número Valido Entre (" + min + " - " + max + ").");
            }
        }
        return numero;
    }
    ...
    public static Departamento ingresarDepartamento(List<Propietario> propietarios,
        ...
        if (opcion == 1) {
            ...
            try {
                valorAlicuotaMensual = validarNumero("Valor de la alícuota mensual: ", scanner);
            } catch (InputMismatchException e) {
                System.out.println("Error: Ingrese un número válido para el valor de la alícuota mensual.");
                return null;
            }
            System.out.println("Seleccione el barrio:");
            for (int i = 0; i < barrios.size(); i++) {
